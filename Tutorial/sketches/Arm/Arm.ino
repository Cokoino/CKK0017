...
void turnLR(void){
  if(yL!=123){
    if(0<=yL && yL<=25){arm.right(15);return;}
    if(225<yL && yL<=256){arm.left(15);return;}  
    if(25<yL && yL<=50){arm.right(15);return;}
    if(200<yL && yL<=225){arm.left(15);return;}
    if(50<yL && yL<=75){arm.right(15);return;}
    if(175<yL && yL<=200){arm.left(15);return;}
    if(75<yL && yL<=100){arm.right(15);return;}
    if(150<yL && yL<=175){arm.left(15);return;}
    if(100<yL && yL<=120){arm.right(15);return;}
    if(125<yL && yL<=150){arm.left(15);return;}
  }
}
///////////////////////////////////////////////////////////////
///Servo2///
void turnUD1(void){
  if(xL!=123){
    if(0<=xL && xL<=25){arm.up1(15);delay(20);return;}
    if(225<xL && xL<=256){arm.down1(15);delay(20);return;} 
    if(25<xL && xL<=50){arm.up1(15);delay(20);return;}
    if(200<xL && xL<=225){arm.down1(15);delay(20);return;}
    if(50<xL && xL<=75){arm.up1(15);delay(20);return;}
    if(175<xL && xL<=200){arm.down1(15);delay(20);return;}
    if(75<xL && xL<=100){arm.up1(15);delay(20);return;}
    if(150<xL && xL<=175){arm.down1(15);delay(20);return;}
    if(100<xL && xL<=122){arm.up1(15);delay(20);return;}
    if(123<xL && xL<=150){arm.down1(15);delay(20);return;} 
  }
}
///////////////////////////////////////////////////////////////
///Servo3///
...
void buzzer(void)
{
  ...
  return;
  }else if(ps2x.ButtonReleased(PSB_PAD_LEFT) || ps2x.ButtonReleased(PSB_PAD_RIGHT)) {
